...
const BookingRegularSelectPax: React.FC<BookingRegularSelectPaxProps> = ({history,loadTourProductData,setTourProductStartDate,loadTourBookingData,TourProductPricingIndex,TourProductDetail,TourProductStartDate,TourBookingLastSubmit}) => {
  ...
  return (
    <IonPage>
      ...
      <IonContent fullscreen={true} class="BookingRegularSelectPax">
        <IonItem hidden={true}>
        <IonDatetime ref={datePicker} displayFormat="MM/DD/YYYY" min={new Date().toISOString()} max={new Date(new Date().setFullYear(new Date().getFullYear() + 5)).toISOString()} value={selectedDate} onIonChange={e =>
          {
