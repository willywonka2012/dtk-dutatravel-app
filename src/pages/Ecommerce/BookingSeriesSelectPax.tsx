...
const BookingSeriesSelectPax: React.FC<BookingSeriesSelectPaxProps> = ({history,loadTourBookingData,TourProductPricingIndex,TourProductDetail,TourProductStartDate,TourBookingLastSubmit}) => {
      ...
      <IonContent fullscreen={true} class="BookingSeriesSelectPax">
        <IonGrid className="white-bg ion-padding">
          ...
          <IonCol size="8">
            ...
            <IonText color="medium"><small>{TourProductStartDate}</small></IonText>
            </div>
              </IonCol>
