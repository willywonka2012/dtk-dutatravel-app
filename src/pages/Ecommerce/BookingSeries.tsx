...
const BookingSeries: React.FC<BookingSeriesProps> = ({history,TourProductDetail,setTourProductPricingId,setTourProductPricingIndex,TourProductPricingIndex,setTourProductStartDate}) => {
  ...
  const handleDateChange = (index:number) => {
    ...
    setTourProductStartDate(cSharpDateCovert(TourProductDetail.TourProductPricingList[index].TourProductPricingTanggal));
  ...
  return (
    <IonPage>
      ...
      <IonContent fullscreen={true} class="BookingSeries">
