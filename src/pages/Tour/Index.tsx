...
const Index: React.FC<IndexProps> = ({history}) => {
  ...
  const [selectedStartDate, setSelectedStartDate] = useState<string>(new Date(today.setDate(new Date().getDate() + 6)).toISOString());
  const [selectedEndDate, setSelectedEndDate] = useState<string>(new Date(new Date().setDate(new Date().getDate() + 13)).toISOString());
  ...
  return (
    <IonPage id="tourIndex">
      ...
      <IonCard className="ion-no-margin ion-padding-bottom ion-header-card">
        <IonCardContent className="ion-no-padding">
          ...
          <IonItem>
            ...
            <IonDatetime
              min={new Date(new Date().setDate(new Date().getDate() + 6)).toISOString()}
          ...
          <IonItem>
            ...
            <IonDatetime
              min={new Date(new Date().setDate(new Date().getDate() + 13)).toISOString()}
              max={new Date(new Date().setFullYear(new Date().getFullYear() + 10)).toISOString()}
      ...
      <NewProducts HideLinkAllView={true}/>
